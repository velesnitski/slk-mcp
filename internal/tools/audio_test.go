...
func (f *fakeAudioClient) RecentFileMessages(ctx context.Context, channelID string, accept func(goslack.File) bool, fromUserID string, limit int) ([]goslack.Message, error) {
